...
The experiment we have conducted has shown that the our qubit-resonator system can't be described by Rabi model. This result probably has its roots in the sample defects, which are hard to model. Nevertheless, qualitative effects are observable even with a qubit of low quality.
\end{tcolorbox}
